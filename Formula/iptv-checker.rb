class IptvChecker < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/kristofferR/IPTVChecker/releases/download/v#{version}/IPTV.Checker_#{version}_mac_arm.app.tar.gz"
      sha256 "f4a03acfeeb743787677338d774c324e7325411acea7b64f48df2cb83552490d"
    end
    on_intel do
      url "https://github.com/kristofferR/IPTVChecker/releases/download/v#{version}/IPTV.Checker_#{version}_mac_x64.app.tar.gz"
